...
if ( ! function_exists( 'oblique_setup' ) ) :
	...
	function oblique_setup() {
		...
		add_image_size( 'oblique-entry-thumb', 540 );
		add_image_size( 'oblique-single-thumb', 1040 );
		add_image_size( 'oblique-slider', 1000, 350, true );
...
function oblique_footer_credits() {
	...
	if ( $credits ) {
		...
		printf( __( 'Theme: %2$s by %1$s.', 'oblique' ), 'Themeisle', '<a href="http://themeisle.com/themes/oblique-pro/" rel="nofollow">Oblique Pro</a>' );
		echo '</div>';
	}
}
 ...
 * Pro
 */
require get_template_directory() . '/inc/pro/customizer.php';
require get_template_directory() . '/inc/pro/functions.php';
require get_template_directory() . '/inc/pro/styles.php';
require get_template_directory() . '/inc/pro/video-format.php';
require get_template_directory() . '/inc/pro/single-colors.php';
 ...
 * Post bototm svg
 */
function oblique_post_bottom_svg() {
	echo oblique_svg_1();
}
add_action( 'oblique_post_bottom_svg', 'oblique_post_bottom_svg' );
