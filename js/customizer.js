...
( function( $ ) {
    ...
    //Extra Color - Social Icons
    wp.customize('social_icons_color',function( value ) {
        value.bind( function( newval ) {
            $('.social-navigation li a').css('color', newval);
        });
    });

    //Extra Color - Widget Background
    wp.customize('widgets_background',function( value ) {
        value.bind( function( newval ) {
            $('#secondary .widget').css('background-color', newval);
        });
    });

    //Extra Color - Widget Color
    wp.customize('widgets_color',function( value ) {
        value.bind( function( newval ) {
            $('#secondary .widget, #secondary .widget ul li a').css('color', newval);
        });
    });

    //Extra Color - Footer Menu Color
    wp.customize('footer_menu_color',function( value ) {
        value.bind( function( newval ) {
            $('.footer-navigation li a').css('color', newval);
        });
    });

    //Extra Color - Entry title
	...
	// Font sizes
	wp.customize(
		'site_title_size',function( value ) {
			value.bind(
				function( newval ) {
	...
	// Site title
	wp.customize(
		'site_title_color',function( value ) {
			value.bind(
				function( newval ) {
	...
	// Site desc
	wp.customize(
		'site_desc_color',function( value ) {
			value.bind(
				function( newval ) {
	...
	// Body text color
	wp.customize(
		'body_text_color',function( value ) {
			value.bind(
				function( newval ) {
    ...
    // Post inner color
    wp.customize(
        'post_inner_color',function( value ) {
            value.bind(
                function( newval ) {
                    $( '.post-inner, .woocommerce-page ul.products li.product, .woocommerce-page ul.products li.product div.post-bottom-svg' ).css( 'background-color', newval );
                }
            );
        }
    );
	...
	// Footer background
	wp.customize(
		'footer_background', function( value ) {
			value.bind(
				function( newval ) {
	...
	// Padding - Header
	wp.customize(
		'branding_padding', function( value ) {
			value.bind(
				function( val ) {
	...
	// Padding < 1024 - Header
	wp.customize(
		'branding_padding_1024', function( value ) {
			value.bind(
				function( val ) {
					if ( window.innerWidth <= 1024 ) {
						$( '.site-branding' ).css(
