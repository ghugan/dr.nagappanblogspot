...
function oblique_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new Oblique_Info(
			$wp_customize, 'oblique_theme_info', array(
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			$wp_customize, 'site_desc_color', array(
				'label'    => __( 'Site description', 'oblique' ),
				'section'  => 'colors',
				'priority' => 14,
			)
	...
	// Post inner
	$wp_customize->add_setting(
		'post_inner_color', array(
			'default'           => apply_filters( 'oblique_post_inner_color', '#ffffff' ),
			'sanitize_callback' => 'sanitize_hex_color',
			'transport'         => 'postMessage',
		)
	);
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			$wp_customize, 'post_inner_color', array(
				'label'    => __( 'Post inner', 'oblique' ),
				'section'  => 'colors',
				'settings' => 'post_inner_color',
				'priority' => 15,
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			$wp_customize, 'entry_titles', array(
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			$wp_customize, 'sidebar_color', array(
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			$wp_customize, 'menu_icon_color', array(
				'label'    => __( 'Menu icon/Leave a review color', 'oblique' ),
				'section'  => 'colors',
